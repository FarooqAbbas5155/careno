                  ...
                  Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        TextWidget(
                            "Year", vehicle.vehicleYear, "Type", category.name),
                        TextWidget("Color", vehicle.vehicleColor, "Seats",
                            vehicle.vehicleSeats),
                        TextWidget("Transmission", vehicle.vehicleTransmission,
                            ...
                            return CustomButton(
                                ...
                                onPressed: () async {
                                  ...
                                  await PaymentsController2().makePayment(
                                    ...
                                    var user =
                                        Get.find<HomeController>().user.value;
                                    await FCM.sendMessageSingle(
                                      "Payment Paid",
                                      "${user!.name} has Send you Payment for Booking",
