...
class LayoutHostActiveVehicle extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<QuerySnapshot>(stream: addVehicleRef.where("status",isEqualTo: "Active").where("hostId",isEqualTo:FirebaseUtils.myId).snapshots(), builder: (BuildContext context,  snapshot) {
