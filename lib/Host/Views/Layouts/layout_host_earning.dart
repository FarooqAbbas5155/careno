                      ...
                      children: [
                        Container(
                          ...
                          decoration: BoxDecoration(
                              ...
                              boxShadow: [
                                BoxShadow(color: Colors.black.withOpacity(.15),
                                    blurRadius: 20.r,
                                    offset: Offset(0, -2))
                              ]
                          ),
                          child: Column(children: [
                            ListTile(
                              ...
                              subtitle: Obx(() {
                                return Text(
                                  "${Get.find<ControllerHostHome>().user.value!.currentBalance.toString()}${currencyUnit}", style: TextStyle(
                            ...
                            RichText(text: TextSpan(
                                ...
                                children: [
                                  TextSpan(
                                    text: "Payment transfer to your local bank account, conne-cted through Active Tutors Stripe Connect Account, may take 2-3 business days.",
                                    style: TextStyle(
                                        color: Color(0xFF969696),
                                        fontWeight: FontWeight.w700,
                                        fontSize: 14.sp
                        ...
                        Divider(color: Color(0xFFBBBBBB).withOpacity(.5),
                          thickness: .5,
                          height: 20.h,),
