...
class _ScreenLocationState extends State<ScreenLocation> {
  ...
  displayPrediction(Prediction? p,) async {
    ...
    if (p != null) {
      ...
      controller.longitude.value = detail.result.geometry!.location.lat;
      ...
      if(controller.longitude.value!=null && controller.longitude.value!=null){
        await add(controller.longitude.value,controller.longitude.value,controller.address.value);

        mapNavigateOnPoints(controller.longitude.value,controller.longitude.value);
      }
      setState(() {});
    }
  }
